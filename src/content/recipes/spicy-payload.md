...
cyber_concept: "Payload Delivery"
prep_time: "15 min"
cook_time: "45 min"
total_time: "1 hour"
servings: "24 pieces"
...
ingredients:
  ...
  - "1/4 cup Kewpie mayo (Japanese version, not American formula)"
  - "1 tbsp Dijon mustard"
  - "1 tbsp horseradish (fresh grated preferred; prepared creamy for milder heat)"
...
instructions:
  - "Hard-boil 12 eggs, then chill and peel."
  - "Pat eggs completely dry to prevent surface bubbling during smoke."
  - "Smoke whole peeled eggs at 160-180°F for 15-30 minutes with light apple or cherry smoke."
  - "Halve eggs lengthwise and remove yolks to a bowl."
  - "Mash yolks with mayo, Dijon, horseradish, vinegar, and Cajun seasoning until smooth."
  - "Fold in diced jalapeño. Taste and adjust seasoning and heat."
...
- Smoker or grill with lid (Big Green Egg, kettle, whatever holds temp)
- Piping bag or zip-lock with corner cut (optional but cleaner)
...
- Fresh jalapeño slices (visible warning for the observant)

---

## Instructions

### Stage 1: Establish the Carrier
...
Clean deployment. No spillage, no evidence of tampering. The payload should sit neatly in the carrier, looking exactly like what the target expects to see.

### Stage 7: Social Engineering
...
| Cooking Stage | Attack Chain Phase |
|--------------|-------------------|
| Hard-boiled eggs | Infrastructure / Carrier |
| Drying thoroughly | Packet integrity |
| Light smoke | Initial access (subtle, aromatic) |
| Hollowed whites | Persistence mechanism |
| Creamy filling base | Obfuscation layer |
| Jalapeño + horseradish | The actual payload |
| Paprika garnish | Social engineering |
| Delayed heat hit | Execution timing |

---

## Pitmaster Notes

**Fresh vs. prepared horseradish:** Fresh grated delivers sharper heat that spikes and fades. Prepared creamy horseradish is milder up front but burns longer. Choose based on whether you want a quick strike or sustained impact.
